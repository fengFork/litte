...
sed -i "s/luciversion.*/luciversion=\"$date1'\"/g" package/lean/default-settings/files/zzz-default-settings
#ctc设置
...
sed -i "s/luciversion.*luciversion=\"$date1'\"/g" package/emortal/default-settings/files/zzz-default-settings
#Lienol设置
